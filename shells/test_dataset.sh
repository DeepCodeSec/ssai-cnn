...
PYTHONPATH="." python3 ./tests/test_dataset.py --ortho_db ./data/mass_buildings/lmdb/train_sat --label_db ./data/mass_buildings/lmdb/train_map --out_dir ./data/mass_buildings/patch_test
